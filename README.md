...
- 这是一个基于 [Anki](https://apps.ankiweb.net/) 制作的日语单词卡组，涵盖 JLPT N1～N5 级别单词以及部分补充词汇，合计约 14,600 个词条。每个单词都附有释义和例句，并提供单词和例句的音频，帮助学习者更好地记忆和理解。
...
- 总单词数：约 14,600 个。
  ...
  - JLPT N1～N5 单词：约 12,500 个。（在 `25.05.19` 版本中新增约 2000 个词汇，并归入子牌组 「补充」）
